...
public class ItemReturnSalesDraftTableModel extends AbstractTableModel {
    ...
    private final ReturnSalesDraftEntity returnsalesdraft;
    private ArrayList<ItemReturnSalesDraftEntity> itemreturnsalesdraftlist;
    private final ArrayList<ItemReturnSalesDraftEntity> deleteditemreturnsalesdraftlist;
    ...
    public ItemReturnSalesDraftTableModel(ArrayList<ItemReturnSalesDraftEntity> itemreturnsalesdraftlist,
            ReturnSalesDraftEntity returnsalesdraft, 
    ...
    public void setValueAt(Object value, int row, int col){
        ItemReturnSalesDraftEntity iis = itemreturnsalesdraftlist.get(row);
        ...
        if(row+1 == getRowCount()){
            itemreturnsalesdraftlist.add(itemreturnsalesdraftController.
                    createEmptyItemReturnSalesDraft(returnsalesdraft));
        }
    }
    
    @Override
    public Object getValueAt(int rowIndex, int columnIndex) {
        ItemReturnSalesDraftEntity iis = itemreturnsalesdraftlist.get(rowIndex);
    ...
    public boolean isCellEditable(int row, int col){
        if(getItemReturnSalesDraftList().get(row).getItem() != null){
    ...
    public void addRow(ItemReturnSalesDraftEntity iis) {
        itemreturnsalesdraftlist.add(iis);
    }
    
    public void deleteRow(int rownum){
          
        ItemReturnSalesDraftEntity iis = itemreturnsalesdraftlist.get(rownum);
        
        deleteditemreturnsalesdraftlist.add(iis);
...
//        
    ...
    public List<ItemReturnSalesDraftEntity> getItemReturnSalesDraftList(){
        return itemreturnsalesdraftlist;
    }
    
    public List<ItemReturnSalesDraftEntity> getDeletedItemReturnSalesDraftList(){
        return deleteditemreturnsalesdraftlist;
    }
    
    public void setItemReturnSalesDraftList(ArrayList<ItemReturnSalesDraftEntity> 
            itemreturnsalesdraftlist){
        this.itemreturnsalesdraftlist = itemreturnsalesdraftlist;
    ...
    public boolean isEmpty(){
        ...
        for(ItemReturnSalesDraftEntity id : itemreturnsalesdraftlist){
            if(id.getItem() != null){
                status = false;
            }
        }
    ...
    public ItemReturnSalesDraftEntity getItemReturnSalesDraft(int index){
