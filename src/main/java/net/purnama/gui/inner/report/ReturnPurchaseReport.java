...
import net.purnama.tablemodel.ReturnPurchaseTableModel2;
 ...
 * @author Purnama
 */
public class ReturnPurchaseReport extends ReportPanel{
    ...
    public ReturnPurchaseReport(int index) {
        super(GlobalFields.PROPERTIES.getProperty("LABEL_REPORT_RETURNPURCHASE"), index);
    ...
    protected void submit() {
        ...
        SwingWorker<Boolean, String> worker = new SwingWorker<Boolean, String>() {
            ...
            protected Boolean doInBackground() {
                ...
                clientresponse = RestClient.get("getReturnPurchaseList?startdate=" + start
                        + "&enddate=" + end
            ...
            protected void done() {
                ...
                if(clientresponse == null){
                    ...
                    try{
                        ArrayList<ReturnPurchaseEntity> list = mapper.readValue(output,
                            TypeFactory.defaultInstance().constructCollectionType(ArrayList.class,
                                    ReturnPurchaseEntity.class));
                        
                        double total = 0;
                        
                        for(ReturnPurchaseEntity invoice : list){
                            total += invoice.getTotal_after_tax();
                        }
                        
                        ReturnPurchaseTableModel2 istm = new ReturnPurchaseTableModel2(list);
                        ...
                        tabbedPane.insertTab(index+1,
                            GlobalFields.PROPERTIES.getProperty("LABEL_REPORT_RETURNPURCHASE"),
                            jasperViewer);
                    }
                    catch(IOException e){

                    } catch (JRException ex) {
                        Logger.getLogger(ReturnPurchaseReport.class.getName()).log(Level.SEVERE, null, ex);
                    }
                }
            }
        };
