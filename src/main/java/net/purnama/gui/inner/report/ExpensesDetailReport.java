 ...
 * @author Purnama
 */
public class ExpensesDetailReport extends ReportPanel{
    ...
    public ExpensesDetailReport(int index) {
        super(GlobalFields.PROPERTIES.getProperty("LABEL_REPORT_EXPENSESDETAIL"), index);
    ...
    protected void submit() {
        ...
        SwingWorker<Boolean, String> worker = new SwingWorker<Boolean, String>() {
            ...
            protected Boolean doInBackground() {
                ...
                clientresponse = RestClient.get("getItemExpensesList?startdate=" + start
                        + "&enddate=" + end
            ...
            protected void done() {
                ...
                if(clientresponse == null){
                    ...
                    try{
                        ArrayList<ItemExpensesEntity> list = mapper.readValue(output,
                        ...
                        tabbedPane.insertTab(index+1,
                            GlobalFields.PROPERTIES.getProperty("LABEL_REPORT_EXPENSESDETAIL"),
                            jasperViewer);
                    }
                    catch(IOException e){
                        e.printStackTrace();
