...
import net.purnama.tablemodel.InvoicePurchaseTableModel2;
 ...
 * @author Purnama
 */
public class InvoicePurchaseReport extends ReportPanel{
    ...
    public InvoicePurchaseReport(int index) {
        super(GlobalFields.PROPERTIES.getProperty("LABEL_REPORT_INVOICEPURCHASE"), index);
    ...
    protected void submit() {
        ...
        SwingWorker<Boolean, String> worker = new SwingWorker<Boolean, String>() {
            ...
            protected Boolean doInBackground() {
                ...
                clientresponse = RestClient.get("getInvoicePurchaseList?startdate=" + start
                        + "&enddate=" + end
            ...
            protected void done() {
                ...
                if(clientresponse == null){
                    ...
                    try{
                        ArrayList<InvoicePurchaseEntity> list = mapper.readValue(output,
                            TypeFactory.defaultInstance().constructCollectionType(ArrayList.class,
                                    InvoicePurchaseEntity.class));
                        
                        double total = 0;
                        
                        for(InvoicePurchaseEntity invoice : list){
                            total += invoice.getTotal_after_tax();
                        }
                        
                        InvoicePurchaseTableModel2 istm = new InvoicePurchaseTableModel2(list);
                        ...
                        tabbedPane.insertTab(index+1,
                            GlobalFields.PROPERTIES.getProperty("LABEL_REPORT_INVOICEPURCHASE"),
                            jasperViewer);
                    }
                    catch(IOException e){

                    } catch (JRException ex) {
                        Logger.getLogger(InvoicePurchaseReport.class.getName()).log(Level.SEVERE, null, ex);
                    }
                }
            }
        };
