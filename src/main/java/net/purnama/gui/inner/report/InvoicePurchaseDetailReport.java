 ...
 * @author Purnama
 */
public class InvoicePurchaseDetailReport extends ReportPanel{
    ...
    public InvoicePurchaseDetailReport(int index){
        super(GlobalFields.PROPERTIES.getProperty("LABEL_REPORT_INVOICEPURCHASEDETAIL"), index);
    ...
    protected void submit() {
        ...
        SwingWorker<Boolean, String> worker = new SwingWorker<Boolean, String>() {
            ...
            protected Boolean doInBackground() {
                ...
                clientresponse = RestClient.get("getItemInvoicePurchaseList?startdate=" + start
                        + "&enddate=" + end
            ...
            protected void done() {
                ...
                if(clientresponse == null){
                    ...
                    try{
                        ArrayList<ItemInvoicePurchaseEntity> list = mapper.readValue(output,
                            TypeFactory.defaultInstance().constructCollectionType(ArrayList.class,
                                    ItemInvoicePurchaseEntity.class));
                        ...
                        tabbedPane.insertTab(index+1,
                            GlobalFields.PROPERTIES.getProperty("LABEL_REPORT_INVOICEPURCHASEDETAIL"),
                            jasperViewer);
                    }
                    catch(IOException e){
