 ...
 * @author Purnama
 */
public class ReturnPurchaseDetailReport extends ReportPanel{
    ...
    public ReturnPurchaseDetailReport(int index){
        super(GlobalFields.PROPERTIES.getProperty("LABEL_REPORT_RETURNPURCHASEDETAIL"), index);
    ...
    protected void submit() {
        ...
        SwingWorker<Boolean, String> worker = new SwingWorker<Boolean, String>() {
            ...
            protected Boolean doInBackground() {
                ...
                clientresponse = RestClient.get("getItemReturnPurchaseList?startdate=" + start
                        + "&enddate=" + end
            ...
            protected void done() {
                ...
                if(clientresponse == null){
                    ...
                    try{
                        ArrayList<ItemReturnPurchaseEntity> list = mapper.readValue(output,
                        ...
                        tabbedPane.insertTab(index+1,
                            GlobalFields.PROPERTIES.getProperty("LABEL_REPORT_RETURNPURCHASEDETAIL"),
                            jasperViewer);
                    }
                    catch(IOException e){
