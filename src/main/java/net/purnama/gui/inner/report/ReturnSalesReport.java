...
import net.purnama.tablemodel.ReturnSalesTableModel2;
 ...
 * @author Purnama
 */
public class ReturnSalesReport extends ReportPanel{
    ...
    public ReturnSalesReport(int index){
        super(GlobalFields.PROPERTIES.getProperty("LABEL_REPORT_RETURNSALES"), index);
    ...
    protected void submit() {
        ...
        SwingWorker<Boolean, String> worker = new SwingWorker<Boolean, String>() {
            ...
            protected Boolean doInBackground() {
                ...
                clientresponse = RestClient.get("getReturnSalesList?startdate=" + start
                        + "&enddate=" + end
            ...
            protected void done() {
                ...
                if(clientresponse == null){
                    ...
                    try{
                        ArrayList<ReturnSalesEntity> list = mapper.readValue(output,
                            TypeFactory.defaultInstance().constructCollectionType(ArrayList.class,
                                    ReturnSalesEntity.class));
                        
                        double total = 0;
                        
                        for(ReturnSalesEntity invoice : list){
                            total += invoice.getTotal_after_tax();
                        }
                        
                        ReturnSalesTableModel2 istm = new ReturnSalesTableModel2(list);
                        ...
                        tabbedPane.insertTab(index+1,
                            GlobalFields.PROPERTIES.getProperty("LABEL_REPORT_RETURNSALES"),
                            jasperViewer);
                    }
                    catch(IOException e){

                    } catch (JRException ex) {
                        Logger.getLogger(ReturnSalesReport.class.getName()).log(Level.SEVERE, null, ex);
                    }
                }
            }
        };
