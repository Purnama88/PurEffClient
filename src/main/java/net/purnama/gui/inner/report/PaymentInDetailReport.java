 ...
 * @author Purnama
 */
public class PaymentInDetailReport extends ReportPanel{
    ...
    public PaymentInDetailReport(int index) {
        super(GlobalFields.PROPERTIES.getProperty("LABEL_REPORT_PAYMENTINDETAIL"), index);
