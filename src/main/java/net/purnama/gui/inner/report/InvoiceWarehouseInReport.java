 ...
 * @author Purnama
 */
public class InvoiceWarehouseInReport extends ReportPanel{

    private final WarehouseComboBoxPanel warehousepanel, originpanel;
    
    private final DatePanel startdatepanel, enddatepanel;
    
    private final StatusPanel statuspanel;
    
    public InvoiceWarehouseInReport(int index) {
        super(GlobalFields.PROPERTIES.getProperty("LABEL_REPORT_INVOICEWAREHOUSEINDETAIL"), index);
        
        warehousepanel = new WarehouseComboBoxPanel();
        originpanel = new WarehouseComboBoxPanel();
        originpanel.setLabel(GlobalFields.PROPERTIES.getProperty("LABEL_ORIGIN"));
    ...
    protected void submit() {
        ...
        SwingWorker<Boolean, String> worker = new SwingWorker<Boolean, String>() {
            ...
            protected Boolean doInBackground() {
                ...
                clientresponse = RestClient.get("getItemInvoiceWarehouseInList?startdate=" + start
                        + "&enddate=" + end
                        + "&warehouseid=" + warehousepanel.getComboBoxValue().getId()
                        + "&originid=" + originpanel.getComboBoxValue().getId()
            ...
            protected void done() {
                ...
                if(clientresponse == null){
                    ...
                    try{
                        ArrayList<ItemInvoiceWarehouseInEntity> list = mapper.readValue(output,
                        ...
                        tabbedPane.insertTab(index+1,
                            GlobalFields.PROPERTIES.getProperty("LABEL_REPORT_INVOICEWAREHOUSEINDETAIL"),
                            jasperViewer);
                    }
                    catch(IOException e){
                        e.printStackTrace();
                        ...
                        Logger.getLogger(InvoiceWarehouseInReport.class.getName()).log(Level.SEVERE, null, ex);
                    }
                }
            }
        };
