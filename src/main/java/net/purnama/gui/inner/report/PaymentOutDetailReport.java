 ...
 * @author Purnama
 */
public class PaymentOutDetailReport extends ReportPanel{
    ...
    public PaymentOutDetailReport(int index) {
        super(GlobalFields.PROPERTIES.getProperty("LABEL_REPORT_PAYMENTOUTDETAIL"), index);
                ...
                if(clientresponse == null){
                    ...
                    try{
                        ...
                        tabbedPane.insertTab(index+1,
                            GlobalFields.PROPERTIES.getProperty("LABEL_REPORT_PAYMENTOUTDETAIL"),
                            jasperViewer);
                    }
                    catch(IOException e){
