 ...
 * @author Purnama
 */
public class PaymentTypeOutReport extends ReportPanel{
    ...
    public PaymentTypeOutReport(int index) {
        super(GlobalFields.PROPERTIES.getProperty("LABEL_REPORT_PAYMENTTYPEOUT"), index);
        ...
        typepanel= new StringComboBoxPanel(GlobalFields.PROPERTIES.getProperty("LABEL_TYPE"), PaymentTypeOutEntity.PAYMENT_TYPE);
    ...
    protected void submit() {
        ...
        SwingWorker<Boolean, String> worker = new SwingWorker<Boolean, String>() {
            ...
            protected Boolean doInBackground() {
                ...
                clientresponse = RestClient.get("getPaymentTypeOutList?startdate=" + start
                        + "&enddate=" + end
            ...
            protected void done() {
                ...
                if(clientresponse == null){
                    ...
                    try{
                        ArrayList<PaymentTypeOutEntity> list = mapper.readValue(output,
