 ...
 * @author Purnama
 */
public class AdjustmentReport extends ReportPanel{
    ...
    public AdjustmentReport(int index) {
        super(GlobalFields.PROPERTIES.getProperty("LABEL_REPORT_ADJUSTMENTDETAIL"), index);
    ...
    protected void submit() {
        ...
        SwingWorker<Boolean, String> worker = new SwingWorker<Boolean, String>() {
            ...
            protected Boolean doInBackground() {
                ...
                clientresponse = RestClient.get("getItemAdjustmentList?startdate=" + start
                        + "&enddate=" + end
            ...
            protected void done() {
                ...
                if(clientresponse == null){
                    ...
                    try{
                        ArrayList<ItemAdjustmentEntity> list = mapper.readValue(output,
                        ...
                        tabbedPane.insertTab(index+1,
                            GlobalFields.PROPERTIES.getProperty("LABEL_REPORT_ADJUSTMENTDETAIL"),
                            jasperViewer);
                    }
                    catch(IOException e){
                        e.printStackTrace();
