...
import net.purnama.tablemodel.InvoiceSalesTableModel2;
 ...
 * @author Purnama
 */
public class InvoiceSalesReport extends ReportPanel{
    ...
    public InvoiceSalesReport(int index){
        super(GlobalFields.PROPERTIES.getProperty("LABEL_REPORT_INVOICESALES"), index);
    ...
    protected void submit() {
        ...
        SwingWorker<Boolean, String> worker = new SwingWorker<Boolean, String>() {
            ...
            protected Boolean doInBackground() {
                ...
                clientresponse = RestClient.get("getInvoiceSalesList?startdate=" + start
                        + "&enddate=" + end
            ...
            protected void done() {
                ...
                if(clientresponse == null){
                    ...
                    try{
                        ArrayList<InvoiceSalesEntity> list = mapper.readValue(output,
                            TypeFactory.defaultInstance().constructCollectionType(ArrayList.class,
                                    InvoiceSalesEntity.class));
                        
                        double total = 0;
                        
                        for(InvoiceSalesEntity invoice : list){
                            total += invoice.getTotal_after_tax();
                        }
                        
                        InvoiceSalesTableModel2 istm = new InvoiceSalesTableModel2(list);
                        ...
                        tabbedPane.insertTab(index+1,
                            GlobalFields.PROPERTIES.getProperty("LABEL_REPORT_INVOICESALES"),
                            jasperViewer);
                    }
                    catch(IOException e){
