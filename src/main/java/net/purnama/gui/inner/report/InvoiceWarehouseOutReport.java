 ...
 * @author Purnama
 */
public class InvoiceWarehouseOutReport extends ReportPanel{

    private final WarehouseComboBoxPanel warehousepanel, destinationpanel;
    
    private final DatePanel startdatepanel, enddatepanel;
    
    private final StatusPanel statuspanel;
    
    public InvoiceWarehouseOutReport(int index) {
        super(GlobalFields.PROPERTIES.getProperty("LABEL_REPORT_INVOICEWAREHOUSEOUTDETAIL"), index);
        
        warehousepanel = new WarehouseComboBoxPanel();
        destinationpanel = new WarehouseComboBoxPanel();
        destinationpanel.setLabel(GlobalFields.PROPERTIES.getProperty("LABEL_DESTINATION"));
    ...
    protected void submit() {
        ...
        SwingWorker<Boolean, String> worker = new SwingWorker<Boolean, String>() {
            ...
            protected Boolean doInBackground() {
                ...
                clientresponse = RestClient.get("getItemInvoiceWarehouseOutList?startdate=" + start
                        + "&enddate=" + end
                        + "&warehouseid=" + warehousepanel.getComboBoxValue().getId()
                        + "&destinationid=" + destinationpanel.getComboBoxValue().getId()
            ...
            protected void done() {
                ...
                if(clientresponse == null){
                    ...
                    try{
                        ArrayList<ItemInvoiceWarehouseOutEntity> list = mapper.readValue(output,
                        ...
                        tabbedPane.insertTab(index+1,
                            GlobalFields.PROPERTIES.getProperty("LABEL_REPORT_INVOICEWAREHOUSEOUTDETAIL"),
                            jasperViewer);
                    }
                    catch(IOException e){
                        e.printStackTrace();
                        ...
                        Logger.getLogger(InvoiceWarehouseOutReport.class.getName()).log(Level.SEVERE, null, ex);
                    }
                }
            }
        };
