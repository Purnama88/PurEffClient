...
import net.purnama.tablemodel.ExpensesTableModel2;
 ...
 * @author Purnama
 */
public class ExpensesReport extends ReportPanel{
    ...
    public ExpensesReport(int index) {
        super(GlobalFields.PROPERTIES.getProperty("LABEL_REPORT_EXPENSES"), index);
    ...
    protected void submit() {
        ...
        SwingWorker<Boolean, String> worker = new SwingWorker<Boolean, String>() {
            ...
            protected Boolean doInBackground() {
                ...
                clientresponse = RestClient.get("getExpensesList?startdate=" + start
                        + "&enddate=" + end
            ...
            protected void done() {
                ...
                if(clientresponse == null){
                    ...
                    try{
                        ArrayList<ExpensesEntity> list = mapper.readValue(output,
                            TypeFactory.defaultInstance().constructCollectionType(ArrayList.class,
                                    ExpensesEntity.class));
                        
                        double total = 0;
                        
                        for(ExpensesEntity invoice : list){
                            total += invoice.getTotal_after_tax();
                        }
                        
                        ExpensesTableModel2 istm = new ExpensesTableModel2(list);
                        ...
                        tabbedPane.insertTab(index+1,
                            GlobalFields.PROPERTIES.getProperty("LABEL_REPORT_EXPENSES"),
                            jasperViewer);
                    }
                    catch(IOException e){
