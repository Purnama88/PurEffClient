 ...
 * @author Purnama
 */
public class ReturnSalesDetailReport extends ReportPanel{
    ...
    public ReturnSalesDetailReport(int index){
        super(GlobalFields.PROPERTIES.getProperty("LABEL_REPORT_RETURNSALESDETAIL"), index);
    ...
    protected void submit() {
        ...
        SwingWorker<Boolean, String> worker = new SwingWorker<Boolean, String>() {
            ...
            protected Boolean doInBackground() {
                ...
                clientresponse = RestClient.get("getItemReturnSalesList?startdate=" + start
                        + "&enddate=" + end
            ...
            protected void done() {
                ...
                if(clientresponse == null){
                    ...
                    try{
                        ArrayList<ItemReturnSalesEntity> list = mapper.readValue(output,
                        ...
                        tabbedPane.insertTab(index+1,
                            GlobalFields.PROPERTIES.getProperty("LABEL_REPORT_RETURNSALESDETAIL"),
                            jasperViewer);
                    }
                    catch(IOException e){
