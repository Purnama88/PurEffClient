 ...
 * @author Purnama
 */
public class UomInvoiceWarehouseInTableCellEditor extends AbstractCellEditor implements TableCellEditor{
    ...
    public UomInvoiceWarehouseInTableCellEditor(){
        super();
    ...
    public Component getTableCellEditorComponent(JTable table, Object value, boolean isSelected, int row, int column) {
        ItemInvoiceWarehouseInDraftTableModel tm = (ItemInvoiceWarehouseInDraftTableModel)table.getModel();
        
        ItemInvoiceWarehouseInDraftEntity iisde = tm.getItemInvoiceWarehouseInDraft(table.
