 ...
 * @author Purnama
 */
public class UomInvoiceSalesTableCellEditor extends AbstractCellEditor implements TableCellEditor{
    ...
    public UomInvoiceSalesTableCellEditor(){
        super();
    ...
    public Component getTableCellEditorComponent(JTable table, Object value, boolean isSelected, int row, int column) {
        ItemInvoiceSalesDraftTableModel tm = (ItemInvoiceSalesDraftTableModel)table.getModel();
        
        ItemInvoiceSalesDraftEntity iisde = tm.getItemInvoiceSalesDraft(table.
