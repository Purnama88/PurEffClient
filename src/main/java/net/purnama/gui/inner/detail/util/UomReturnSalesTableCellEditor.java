 ...
 * @author Purnama
 */
public class UomReturnSalesTableCellEditor extends AbstractCellEditor implements TableCellEditor{
    ...
    public UomReturnSalesTableCellEditor(){
        super();
    ...
    public Component getTableCellEditorComponent(JTable table, Object value, boolean isSelected, int row, int column) {
        ItemReturnSalesDraftTableModel tm = (ItemReturnSalesDraftTableModel)table.getModel();
        
        ItemReturnSalesDraftEntity iisde = tm.getItemReturnSalesDraft(table.
