 ...
 * @author Purnama
 */
public class UomReturnPurchaseTableCellEditor extends AbstractCellEditor implements TableCellEditor{
    ...
    public UomReturnPurchaseTableCellEditor(){
        super();
    ...
    public Component getTableCellEditorComponent(JTable table, Object value, boolean isSelected, int row, int column) {
        ItemReturnPurchaseDraftTableModel tm = (ItemReturnPurchaseDraftTableModel)table.getModel();
        
        ItemReturnPurchaseDraftEntity iisde = tm.getItemReturnPurchaseDraft(table.
