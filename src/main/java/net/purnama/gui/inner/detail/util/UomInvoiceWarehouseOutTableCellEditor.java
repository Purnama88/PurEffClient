 ...
 * @author Purnama
 */
public class UomInvoiceWarehouseOutTableCellEditor extends AbstractCellEditor implements TableCellEditor{
    ...
    public UomInvoiceWarehouseOutTableCellEditor(){
        super();
    ...
    public Component getTableCellEditorComponent(JTable table, Object value, boolean isSelected, int row, int column) {
        ItemInvoiceWarehouseOutDraftTableModel tm = (ItemInvoiceWarehouseOutDraftTableModel)table.getModel();
        
        ItemInvoiceWarehouseOutDraftEntity iisde = tm.getItemInvoiceWarehouseOutDraft(table.
