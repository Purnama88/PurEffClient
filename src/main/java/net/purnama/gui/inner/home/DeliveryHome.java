...
import net.purnama.gui.inner.detail.DeliveryDetail;
...
import net.purnama.tablemodel.DeliveryTableModel;
...
public class DeliveryHome extends HomePanel{
    ...
    public DeliveryHome(){
        super(GlobalFields.PROPERTIES.getProperty("LABEL_PANEL_DELIVERYHOME"));
        
        list = new ArrayList<>();
        
        deliverytablemodel = new DeliveryTableModel(list);
...
//        table.setRowSorter(sorter);
    ...
    protected void detail() {
        ...
        DeliveryEntity delivery = deliverytablemodel.getDelivery(table.
                    convertRowIndexToModel(table.getSelectedRow()));
        
        tabbedPane.changeTabPanel(getIndex(), new DeliveryDetail(delivery.getId()));
    }
    ...
    protected final void filter() {
        ...
        SwingWorker<Boolean, String> numworker = new SwingWorker<Boolean, String>() {
            ...
            protected Boolean doInBackground(){
                response = RestClient.get("countDeliveryList?keyword=" + keyword);
    ...
    protected void loaddata() {
        ...
        SwingWorker<Boolean, String> worker = new SwingWorker<Boolean, String>() {
            ...
            protected Boolean doInBackground(){
                ...
                response = RestClient.get("getDeliveryList?itemperpage=" + itemperpage + "&page=" + 
            ...
            protected void done() {
                ...
                if(response == null){
                    ...
                    try{
                        ...
                        deliverytablemodel.setDeliveryList(list);
                    }
                    catch(IOException e){
    ...
    protected void openinnewtab() {
        ...
        tabbedPane.insertTab(getIndex() + 1, new DeliveryDetail(delivery.getId()));
    }
}
