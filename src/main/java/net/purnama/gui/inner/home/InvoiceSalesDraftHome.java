...
import net.purnama.tablemodel.InvoiceSalesDraftTableModel;
...
public class InvoiceSalesDraftHome extends HomePanel{
    ...
    private ArrayList<InvoiceSalesDraftEntity> list;
    
    public InvoiceSalesDraftHome(){
        super(GlobalFields.PROPERTIES.getProperty("LABEL_PANEL_INVOICESALESDRAFTHOME"));
        
        list = new ArrayList<>();
        
        invoicesalesdrafttablemodel = new InvoiceSalesDraftTableModel(list);
...
//        table.setRowSorter(sorter);
    ...
    protected void detail() {
        ...
        InvoiceSalesDraftEntity invoicesalesdraft = invoicesalesdrafttablemodel.getInvoiceSalesDraft(table.
                    convertRowIndexToModel(table.getSelectedRow()));
        
        tabbedPane.changeTabPanel(getIndex(), new InvoiceSalesDraftDetail(invoicesalesdraft.getId()));
    }
    ...
    protected final void filter() {
        ...
        SwingWorker<Boolean, String> numworker = new SwingWorker<Boolean, String>() {
            ...
            protected Boolean doInBackground(){
                response = RestClient.get("countInvoiceSalesDraftList?keyword=" + keyword);
    ...
    protected void loaddata() {
        ...
        SwingWorker<Boolean, String> worker = new SwingWorker<Boolean, String>() {
            ...
            protected Boolean doInBackground(){
                ...
                response = RestClient.get("getInvoiceSalesDraftList?itemperpage=" + itemperpage + "&page=" + 
                    ...
                    try{
                        list = mapper.readValue(output,
                                TypeFactory.defaultInstance().constructCollectionType(ArrayList.class,
                                        InvoiceSalesDraftEntity.class));
                        
                        invoicesalesdrafttablemodel.setInvoiceSalesDraftList(list);
                    }
                    catch(IOException e){
    ...
    protected void openinnewtab() {
        ...
        tabbedPane.insertTab(getIndex() + 1, new InvoiceSalesDraftDetail(invoicesalesdraft.getId()));
    }
}
