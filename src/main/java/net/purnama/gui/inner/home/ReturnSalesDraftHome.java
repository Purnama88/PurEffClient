...
import net.purnama.tablemodel.ReturnSalesDraftTableModel;
...
public class ReturnSalesDraftHome extends HomePanel{
    ...
    private ArrayList<ReturnSalesDraftEntity> list;
    
    public ReturnSalesDraftHome(){
        super(GlobalFields.PROPERTIES.getProperty("LABEL_PANEL_RETURNSALESDRAFTHOME"));
        
        list = new ArrayList<>();
        
        returnsalesdrafttablemodel = new ReturnSalesDraftTableModel(list);
...
//        table.setRowSorter(sorter);
    ...
    protected void detail() {
        ...
        ReturnSalesDraftEntity returnsalesdraft = returnsalesdrafttablemodel.getReturnSalesDraft(table.
                    convertRowIndexToModel(table.getSelectedRow()));
        
        tabbedPane.changeTabPanel(getIndex(), new ReturnSalesDraftDetail(returnsalesdraft.getId()));
    }
    ...
    protected final void filter() {
        ...
        SwingWorker<Boolean, String> numworker = new SwingWorker<Boolean, String>() {
            ...
            protected Boolean doInBackground(){
                response = RestClient.get("countReturnSalesDraftList?keyword=" + keyword);
    ...
    protected void loaddata() {
        ...
        SwingWorker<Boolean, String> worker = new SwingWorker<Boolean, String>() {
            ...
            protected Boolean doInBackground(){
                ...
                response = RestClient.get("getReturnSalesDraftList?itemperpage=" + itemperpage + "&page=" + 
                    ...
                    try{
                        list = mapper.readValue(output,
                                TypeFactory.defaultInstance().constructCollectionType(ArrayList.class,
                                        ReturnSalesDraftEntity.class));
                        
                        returnsalesdrafttablemodel.setReturnSalesDraftList(list);
                    }
                    catch(IOException e){
    ...
    protected void openinnewtab() {
        ...
        tabbedPane.insertTab(getIndex() + 1, new ReturnSalesDraftDetail(returnsalesdraft.getId()));
    }
}
