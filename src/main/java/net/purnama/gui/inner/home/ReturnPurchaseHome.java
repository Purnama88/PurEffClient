...
import net.purnama.tablemodel.ReturnPurchaseTableModel;
...
public class ReturnPurchaseHome extends HomePanel{
    ...
    private ArrayList<ReturnPurchaseEntity> list;
    
    public ReturnPurchaseHome(){
        super(GlobalFields.PROPERTIES.getProperty("LABEL_PANEL_RETURNPURCHASEHOME"));
        
        list = new ArrayList<>();
        
        returnpurchasetablemodel = new ReturnPurchaseTableModel(list);
...
//        table.setRowSorter(sorter);
    ...
    protected void detail() {
        ...
        ReturnPurchaseEntity returnpurchase = returnpurchasetablemodel.getReturnPurchase(table.
                    convertRowIndexToModel(table.getSelectedRow()));
        
        tabbedPane.changeTabPanel(getIndex(), new ReturnPurchaseDetail(returnpurchase.getId()));
    }
    ...
    protected final void filter() {
        ...
        SwingWorker<Boolean, String> numworker = new SwingWorker<Boolean, String>() {
            ...
            protected Boolean doInBackground(){
                response = RestClient.get("countReturnPurchaseList?keyword=" + keyword);
    ...
    protected void loaddata() {
        ...
        SwingWorker<Boolean, String> worker = new SwingWorker<Boolean, String>() {
            ...
            protected Boolean doInBackground(){
                ...
                response = RestClient.get("getReturnPurchaseList?itemperpage=" + itemperpage + "&page=" + 
                    ...
                    try{
                        list = mapper.readValue(output,
                                TypeFactory.defaultInstance().constructCollectionType(ArrayList.class,
                                        ReturnPurchaseEntity.class));
                        
                        returnpurchasetablemodel.setReturnPurchaseList(list);
                    }
                    catch(IOException e){
    ...
    protected void openinnewtab() {
        ...
        tabbedPane.insertTab(getIndex()+1, new ReturnPurchaseDetail(returnpurchase.getId()));
    }
