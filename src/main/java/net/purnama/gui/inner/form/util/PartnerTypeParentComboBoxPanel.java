 ...
 * @author Purnama
 */
public class PartnerTypeParentComboBoxPanel extends JPanel{
    ...
    public PartnerTypeParentComboBoxPanel(){
        super(new FlowLayout(FlowLayout.LEFT));
        
        list = new ArrayList<>();
        combobox = new JComboBox();
        
        label = new MyLabel(GlobalFields.PROPERTIES.getProperty("LABEL_PARENT"), 150);
    ...
    public final void load(){
        SwingWorker<Boolean, String> worker = new SwingWorker<Boolean, String>(){
            ...
            protected Boolean doInBackground(){
                ...
                response = RestClient.get("getPartnerTypeParentList");
