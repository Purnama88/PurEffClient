...
public class CreditCardPanel extends JPanel{
    ...
    private LabelTextFieldPanel bankpanel, numberpanel, expirypanel;
    private LabelDecimalTextFieldPanel amountpanel;
    private SubmitPanel submitpanel;
    
    public CreditCardPanel(PaymentTypeInDraftTableModel tablemodel, String paymentindraftid,
        ...
        submitpanel.getSubmitButton().addActionListener((ActionEvent e) -> {
            ...
            if(amount > 0){
                PaymentTypeInDraftEntity ptide = paymenttypeindraftController.
                        addPaymentTypeInDraft(GlobalFields.CREDITCARD, 
                                Calendar.getInstance(),
                                bankpanel.getTextFieldValue(),
                                numberpanel.getTextFieldValue(),
                                expirypanel.getTextFieldValue(),
            ...
            expirypanel.setTextFieldValue("");
            amountpanel.setTextFieldValue(0);
            
        });
    }
    
    public CreditCardPanel(PaymentTypeInTableModel tablemodel, String paymentinid, 
        ...
        submitpanel.getSubmitButton().addActionListener((ActionEvent e) -> {
            ...
            if(amount > 0){
                tablemodel.addRow(paymenttypeinController.addPaymentTypeIn(GlobalFields.CREDITCARD, 
                                Calendar.getInstance(),
                                bankpanel.getTextFieldValue(),
                                numberpanel.getTextFieldValue(),
                                expirypanel.getTextFieldValue(), amount, paymentinid));
    ...
    public CreditCardPanel(PaymentTypeOutDraftTableModel tablemodel, String paymentoutdraftid,
            LabelDecimalTextFieldPanel totalpanel, LabelDecimalTextFieldPanel remainingpanel){
        super(new FlowLayout(FlowLayout.LEFT));
        ...
        submitpanel.getSubmitButton().addActionListener((ActionEvent e) -> {
            ...
            if(amount > 0){
                ...
                PaymentTypeOutDraftEntity ptide = paymenttypeoutdraftController.
                        addPaymentTypeOutDraft(GlobalFields.CREDITCARD, 
                                Calendar.getInstance(),
                                bankpanel.getTextFieldValue(),
                                numberpanel.getTextFieldValue(),
                                expirypanel.getTextFieldValue(), amount, paymentoutdraftid);
    ...
    public CreditCardPanel(PaymentTypeOutTableModel tablemodel, String paymentoutid, 
            LabelDecimalTextFieldPanel totalpanel){
        super(new FlowLayout(FlowLayout.LEFT));
        ...
        submitpanel.getSubmitButton().addActionListener((ActionEvent e) -> {
            ...
            if(amount > 0){
                tablemodel.addRow(paymenttypeoutController.addPaymentTypeOut(GlobalFields.CREDITCARD, 
                                Calendar.getInstance(),
                                bankpanel.getTextFieldValue(),
                                numberpanel.getTextFieldValue(),
                                expirypanel.getTextFieldValue(), amount, paymentoutid));
    ...
    public final void init(){
        ...
        expirypanel = new LabelTextFieldPanel(
            GlobalFields.PROPERTIES.getProperty("LABEL_EXPIRY"), "", true);
