...
public class DateUtils {
    ...
    public static Calendar addCalendarbyDay(Calendar calendar, int days){
    ...
    /**
     * <p>Checks if the first calendar date is between the second calendar date 
     * and third calendar date.</p>
     * @param cal1 the first calendar, not altered, not null.
     * @param cal2 the second calendar, not altered, not null.
     * @param cal3 the third calendar, not altered, not null.
     * @return true if cal1 date is between cal2 date and cal3 date.
     * @throws IllegalArgumentException if either of the calendars are <code>null</code>
     */
    public static boolean isBetweenDay(Calendar cal1, Calendar cal2, Calendar cal3){
        if (cal1 == null || cal2 == null || cal3 == null) {
            throw new IllegalArgumentException("The dates must not be null");
        }
        
        return isAfterDay(cal1, cal2) && isBeforeDay(cal1, cal3);
    }
    
    /**
     * <p>Checks if the first calendar date is between or the same time with either
     * the second calendar date 
     * and/or third calendar date.</p>
     * @param cal1 the first calendar, not altered, not null.
     * @param cal2 the second calendar, not altered, not null.
     * @param cal3 the third calendar, not altered, not null.
     * @return true if cal1 date is between cal2 date and cal3 date or cal1 is the same date
     * with cal2 or cal3.
     * @throws IllegalArgumentException if either of the calendars are <code>null</code>
     */
    public static boolean isBetween(Calendar cal1, Calendar cal2, Calendar cal3){
        if (cal1 == null || cal2 == null || cal3 == null) {
            throw new IllegalArgumentException("The dates must not be null");
        }
        
        return (isBetweenDay(cal1, cal2, cal3)) || isSameDay(cal1, cal2) || isSameDay(cal1, cal3);
    }
